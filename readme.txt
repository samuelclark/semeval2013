******************************************
* Semeval 2013 Task 14 Data
*
* http://www.cs.york.ac.uk/semeval-2013/task14/
* 
* Task Co-organizers:
...
The download script works for both tasks, and can be used like so (Thanks to Arturo Montejo Ráez for a very helpful bug fix!):
