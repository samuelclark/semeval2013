...
"""
    This is a massive class that contains the methods that extract features from the tweets text
    While it got bigger than expected, it was nice to be able to use this class as a computational NLP
    wrapper with internal acccess to all the tweets and related information
"""
    ...
    def get_hash_mention_prob(self):
        """
            Gets the probability distribution of all the hastags and mentions in tagged tweets
        """
        hashlist = []
        mentionlist = []
